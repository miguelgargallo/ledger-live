...
function useWebViewEffect({
  webviewRef,
  onMessage,
  onLoad,
}: {
  webviewRef: React.RefObject<WebviewTag>;
  onMessage: ReturnType<typeof useWalletAPIServer>["onMessage"];
  onLoad: ReturnType<typeof useWalletAPIServer>["onLoad"];
}) {
  ...
  }, [webviewRef, onLoad, handleDomReady, handleMessage]);
}
...
function useWebView({ manifest, inputs }: Pick<Props, "manifest" | "inputs">) {
  ...
  useWebViewEffect({ webviewRef, onLoad, onMessage });
