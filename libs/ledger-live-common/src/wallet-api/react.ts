...
export function useConfig({
  ...
  return useMemo(
    ...
    [tracking, userId, wallet, manifest]
  );
}
...
export function useWalletAPIServer({
  ...
  }, [manifest, server, tracking, accounts, uiAccountRequest]);
  ...
  }, [manifest, tracking, accounts, server, uiAccountReceive]);
  ...
  }, [manifest, tracking, accounts, server, uiMessageSign]);
  ...
  }, [uiDeviceTransport, server, device, tracking, manifest]);
  ...
  }, [server, device, tracking, manifest]);
  ...
  }, [server, tracking, manifest, accounts]);
